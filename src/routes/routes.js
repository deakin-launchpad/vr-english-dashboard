...
import { Login, Register, MobileMenu, FourOFour, UserManagement } from 'views';
...
export const AppRoutes = (props) => {
  ...
  let landingPage = (LayoutConfig.landingPage !== undefined ? LayoutConfig.landingPage !== '' ? LayoutConfig.landingPage : '/usermanagement' : '/usermanagement');
  ...
  return (
    <Switch>
      ...
      <Route exact path='/usermanagement' render={() => ((loginStatus === false ? <Redirect to={{ pathname: '/login' }} {...props} /> : <Layout><UserManagement {...props} /></Layout>))} />
